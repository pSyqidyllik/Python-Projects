...
def startup():
    ...
    title = Label(startup_frame, text="Self-Order Kiosk", bg='#272727', fg='#ffffff',
                  font=('Arial Rounded MT Bold', 60), anchor='center', width=30)
    ...
    desc = Label(startup_frame, text="Welcome to Jollibae! Please Enter Your Name (Given/ First Name).",
                 padx=40, pady=10, background="#303030", fg='#ffffff', font=('Arial', 12))
    ...
    def set_cname():
        cname = name_box.get()
        if cname == '':
            messagebox.showerror("Empty Field", "Please Enter your name first. Thank You.")
        else:
            startup.destroy()
            mainmenu(cname)
    ...
    enter_name = Button(startup_frame, text="Enter Name", bg='red', fg='#ffffff', font=('Arial Bold', 30),
                        command=set_cname)
...
def mainmenu(customer_name):
    ...
    title = Label(header, text="   Menu", bg='#272727', fg='#ffffff', font=('Arial Rounded MT Bold', 60))
    title.grid(row=0, column=1, sticky=W+E)

    datet = datetime.datetime.now().strftime("%A %m-%d-20%y, %H:%M:%S")
    datel = Label(header, text=datet, padx=20, pady=20, bg='#272727', fg='#ffffff', font=('Arial Rounded MT Bold', 15),
                  anchor=S + E)
    datel.grid(row=0, column=2, sticky='nsew')

    desc = Label(header, text="Welcome to Jollibae, " + customer_name + "!  Feel free to explore our Menu!", padx=40,
                 pady=10, background="#303030", fg='#ffffff', font=('Arial', 12), width=161, anchor=W)
    desc.grid(row=2, columnspan=3)

    #frame 1 initial, buttons, functions
    ...
    def proceed(orderlist, customer_name):
        if orderlist == []:
            ...
            response= messagebox.askquestion("Proceed to Checkout",
                                             "Would you like to proceed to Checkout and finalize order?")
            if response == "yes":
    ...
    def print_order():
        ...
        for order in orderl:
            ...
            itp = Label(frame3, text=order[1][:18] + '- \n' + order[1][18:], font=('Arial Bold', 10))
        ...
        r+=1
        confirm_orderb = Button(frame3, text="Confirm Order", bg='red', fg='#ffffff', font=('Arial Bold', 15),
                                command=lambda: proceed(orderl, customer_name))
    ...
    #frame1 buttons and functions
    #chicken
    #show menu of clicked category
    def chicken_cat():
        global frame2
        global cat
        ...
        catt = Label(frame2, text=cat, pady=20, padx=20, bg='#272727', fg='#ffffff', font=('Arial Rounded MT Bold', 18),
                     anchor=W)
        ...
        itemb1 = Button(frame2, text=itstr1, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt1, it1, pr1))
        ...
        itemb2 = Button(frame2, text=itstr2, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt2, it2, pr2))
        itemb2.grid(row=2, column=1, sticky=W + E, padx=15)

        # item 3 fill
        tf=ImageTk.PhotoImage(Image.open('assets/tf.png'))
        itemtf = Label(frame2, image=tf, bg='#303030')
        itemtf.grid(row=1, column=2, padx=15)

    #show button
    chicken = Button(frame, text="Chicken           >", fg='#ffffff', bg='#272727', font=('Arial Rounded MT Bold', 15),
                     width=12, command=chicken_cat)
    ...
    def burger_cat():
        global frame2
        global cat
        global itl1, thl1, itl2, thl2, itl3, thl3, itl4, thl4, itl5, thl5
        cat = "Burger"
        ...
        it1=burgerl[0].name
        itstr1= it1 + "\nPHP " + str(pr1) + ".00"
        thl1=ImageTk.PhotoImage(Image.open(burgerl[0].th))
        itemth1 = Label(frame2, image=thl1, bg='#272727')
        itemth1.grid(row=1, column=0, padx=15)
        itemb1 = Button(frame2, text=itstr1, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt1, it1, pr1))
        ...
        it2 = burgerl[1].name
        itstr2 = it2 + "\nPHP " + str(pr2) + ".00"
        thl2 = ImageTk.PhotoImage(Image.open(burgerl[1].th))
        itemth2 = Label(frame2, image=thl2, bg='#272727')
        itemth2.grid(row=1, column=1, padx=15)
        itemb2 = Button(frame2, text=itstr2, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt2, it2, pr2))
        ...
        it3 = burgerl[2].name
        itstr3 = it3 + "\nPHP " + str(pr3) + ".00"
        thl3 = ImageTk.PhotoImage(Image.open(burgerl[2].th))
        itemth3 = Label(frame2, image=thl3, bg='#272727')
        itemth3.grid(row=1, column=2, padx=15)
        itemb3 = Button(frame2, text=itstr3, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt3, it3, pr3))
        itemb3.grid(row=2, column=2, sticky=W + E, padx=15)

        #item fill
        itembt = Label(frame2, bg='#303030', pady=8)
        itembt.grid(row=3, column=0)
        ...
        it4 = burgerl[3].name
        itstr4 = it4 + "\nPHP " + str(pr4) + ".00"
        thl4 = ImageTk.PhotoImage(Image.open(burgerl[3].th))
        itemth4 = Label(frame2, image=thl4, bg='#272727')
        itemth4.grid(row=4, column=0, padx=15)
        itemb4 = Button(frame2, text=itstr4, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt4, it4, pr4))
        itemb4.grid(row=5, column=0, sticky=W + E, padx=15)
        ...
        it5 = burgerl[4].name
        itstr5 = it5 + "\nPHP " + str(pr5) + ".00"
        thl5 = ImageTk.PhotoImage(Image.open(burgerl[4].th))
        itemth5 = Label(frame2, image=thl5, bg='#272727')
        itemth5.grid(row=4, column=1, padx=15)
        itemb5 = Button(frame2, text=itstr5, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt5, it5, pr5))
        itemb5.grid(row=5, column=1, sticky=W + E, padx=15)

    burger = Button(frame, text="Burger             >", fg='#ffffff', bg='#272727', font=('Arial Rounded MT Bold', 15),
                    width=12, command=burger_cat)
    burger.grid(row=2, sticky=E)
    ...
    def spaghetti_cat():
        ...
        qt1=IntVar()
        qt1.set(1)
        pr1=spaghettil[0].price
        it1=spaghettil[0].name
        itstr1= it1 + "\nPHP " + str(pr1) + ".00"
        ...
        qt2 = IntVar()
        qt2.set(1)
        pr2 = spaghettil[1].price
        it2 = spaghettil[1].name
        itstr2 = it2 + "\nPHP " + str(pr2) + ".00"
        ...
        qt3 = IntVar()
        qt3.set(1)
        pr3 = spaghettil[2].price
        it3 = spaghettil[2].name
        itstr3 = it3 + "\nPHP " + str(pr3) + ".00"
    ...
    spaghetti = Button(frame, text="Spaghetti        >", fg='#ffffff', bg='#272727', font=('Arial Rounded MT Bold', 15),
                       width=12, command=spaghetti_cat)
    spaghetti.grid(row=3, sticky=E)
    ...
    def burgerst_cat():
        ...
        qt1=IntVar()
        qt1.set(1)
        pr1=burgerStl[0].price
        it1=burgerStl[0].name
        itstr1= it1 + "\nPHP " + str(pr1) + ".00"
        thl1=ImageTk.PhotoImage(Image.open(burgerStl[0].th))
        itemth1 = Label(frame2, image=thl1, bg='#272727')
        itemth1.grid(row=1, column=0, padx=15)
        itemb1 = Button(frame2, text=itstr1, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt1, it1, pr1))
        ...
        qt2 = IntVar()
        qt2.set(1)
        pr2 = burgerStl[1].price
        it2 = burgerStl[1].name
        itstr2 = it2 + "\nPHP " + str(pr2) + ".00"
        thl2 = ImageTk.PhotoImage(Image.open(burgerStl[1].th))
        itemth2 = Label(frame2, image=thl2, bg='#272727')
        itemth2.grid(row=1, column=1, padx=15)
        itemb2 = Button(frame2, text=itstr2, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt2, it2, pr2))
        ...
        qt3 = IntVar()
        qt3.set(1)
        pr3 = burgerStl[2].price
        it3 = burgerStl[2].name
        itstr3 = it3 + "\nPHP " + str(pr3) + ".00"
        thl3 = ImageTk.PhotoImage(Image.open(burgerStl[2].th))
        itemth3 = Label(frame2, image=thl3, bg='#272727')
        itemth3.grid(row=1, column=2, padx=15)
        itemb3 = Button(frame2, text=itstr3, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt3, it3, pr3))
        ...
        qt4 = IntVar()
        qt4.set(1)
        pr4 = burgerStl[3].price
        it4 = burgerStl[3].name
        itstr4 = it4 + "\nPHP " + str(pr4) + ".00"
        thl4 = ImageTk.PhotoImage(Image.open(burgerStl[3].th))
        itemth4 = Label(frame2, image=thl4, bg='#272727')
        itemth4.grid(row=4, column=0, padx=15)
        itemb4 = Button(frame2, text=itstr4, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt4, it4, pr4))
    ...
    burger_st = Button(frame, text="Burger Steak >", fg='#ffffff', bg='#272727', font=('Arial Rounded MT Bold', 15),
                       width=12, command=burgerst_cat)
    burger_st.grid(row=4, sticky=E)
    ...
    palabok = Button(frame, text="Palabok           >", fg='#ffffff', bg='#272727', font=('Arial Rounded MT Bold', 15),
                     width=12, command=palabok_cat)
    ...
    def beverages_cat():
        ...
        qt1=IntVar()
        qt1.set(1)
        pr1=beveragesl[0].price
        it1=beveragesl[0].name
        itstr1= it1 + "\nPHP " + str(pr1) + ".00"
        thl1=ImageTk.PhotoImage(Image.open(beveragesl[0].th))
        itemth1 = Label(frame2, image=thl1, bg='#272727')
        itemth1.grid(row=1, column=0, padx=15)
        itemb1 = Button(frame2, text=itstr1, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt1, it1, pr1))
        ...
        qt2 = IntVar()
        qt2.set(1)
        pr2 = beveragesl[1].price
        it2 = beveragesl[1].name
        itstr2 = it2 + "\nPHP " + str(pr2) + ".00"
        thl2 = ImageTk.PhotoImage(Image.open(beveragesl[1].th))
        itemth2 = Label(frame2, image=thl2, bg='#272727')
        itemth2.grid(row=1, column=1, padx=15)
        itemb2 = Button(frame2, text=itstr2, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt2, it2, pr2))
        ...
        qt3 = IntVar()
        qt3.set(1)
        pr3 = beveragesl[2].price
        it3 = beveragesl[2].name
        itstr3 = it3 + "\nPHP " + str(pr3) + ".00"
        thl3 = ImageTk.PhotoImage(Image.open(beveragesl[2].th))
        itemth3 = Label(frame2, image=thl3, bg='#272727')
        itemth3.grid(row=1, column=2, padx=15)
        itemb3 = Button(frame2, text=itstr3, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt3, it3, pr3))
        ...
        qt4 = IntVar()
        qt4.set(1)
        pr4 = beveragesl[3].price
        it4 = beveragesl[3].name
        itstr4 = it4 + "\nPHP " + str(pr4) + ".00"
        thl4 = ImageTk.PhotoImage(Image.open(beveragesl[3].th))
        itemth4 = Label(frame2, image=thl4, bg='#272727')
        itemth4.grid(row=4, column=0, padx=15)
        itemb4 = Button(frame2, text=itstr4, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt4, it4, pr4))
        ...
        qt5 = IntVar()
        qt5.set(1)
        pr5 = beveragesl[4].price
        it5 = beveragesl[4].name
        itstr5 = it5 + "\nPHP " + str(pr5) + ".00"
        thl5 = ImageTk.PhotoImage(Image.open(beveragesl[4].th))
        itemth5 = Label(frame2, image=thl5, bg='#272727')
        itemth5.grid(row=4, column=1, padx=15)
        itemb5 = Button(frame2, text=itstr5, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12),
                        command=lambda: order(qt5, it5, pr5))
    ...
    beverages = Button(frame, text="Beverages      >", fg='#ffffff', bg='#272727', font=('Arial Rounded MT Bold', 15),
                       width=12, command=beverages_cat)
    beverages.grid(row=6, sticky=E)
    ...
    def additionals_cat():
        ...
        qt1=IntVar()
        qt1.set(1)
        pr1=additionalsl[0].price
        it1=additionalsl[0].name
        itstr1= it1 + "\nPHP " + str(pr1) + ".00"
        thl1=ImageTk.PhotoImage(Image.open(additionalsl[0].th))
        itemth1 = Label(frame2, image=thl1, bg='#272727')
        itemth1.grid(row=1, column=0, padx=15)
        ...
        qt2 = IntVar()
        qt2.set(1)
        pr2 = additionalsl[1].price
        it2 = additionalsl[1].name
        itstr2 = it2 + "\nPHP " + str(pr2) + ".00"
        thl2 = ImageTk.PhotoImage(Image.open(additionalsl[1].th))
        itemth2 = Label(frame2, image=thl2, bg='#272727')
        itemth2.grid(row=1, column=1, padx=15)
        ...
        qt3 = IntVar()
        qt3.set(1)
        pr3 = additionalsl[2].price
        it3 = additionalsl[2].name
        itstr3 = it3 + "\nPHP " + str(pr3) + ".00"
        thl3 = ImageTk.PhotoImage(Image.open(additionalsl[2].th))
        itemth3 = Label(frame2, image=thl3, bg='#272727')
        itemth3.grid(row=1, column=2, padx=15)
        ...
        qt4 = IntVar()
        qt4.set(1)
        pr4 = additionalsl[3].price
        it4 = additionalsl[3].name
        itstr4 = it4 + "\nPHP " + str(pr4) + ".00"
        thl4 = ImageTk.PhotoImage(Image.open(additionalsl[3].th))
        itemth4 = Label(frame2, image=thl4, bg='#272727')
        itemth4.grid(row=4, column=0, padx=15)
        itemb4 = Button(frame2, text=itstr4, bg='#58E3E4', fg='#000000', font=('Arial Rounded MT Bold', 12), command=lambda: order(qt4, it4, pr4))
        itemb4.grid(row=5, column=0, sticky=W + E, padx=15)

    additionals = Button(frame, text="Additionals     >", fg='#ffffff', bg='#272727', font=('Arial Rounded MT Bold', 15),
                         width=12, command=additionals_cat)
    additionals.grid(row=7, sticky=E)
    ...
    #driver program?, list for menu

    chickenl=[items.opccs(), items.tpccs()]
    burgerl=[items.ys(), items.cys(), items.bcys(), items.cdys(), items.aays()]
    spaghettil=[items.jss(), items.jsfp(), items.fpd()]
    burgerStl=[items.opbss(), items.tpbss(), items.spbsfp(), items.epbsfp()]
    palabokl=[items.ps(), items.pfp(), items.fpd()]
    beveragesl=[items.bsmtp(), items.bsmt(), items.iccj(), items.ic(), items.it()]
    additionalsl=[items.hmd(), items.tid(), items.cms(), items.er()]
...
def confirm_order(orders, customer_name):
    ...
    def get_info(customer_type):
        ...
        if customer_type == 'existing':
            ...
            confirm(customer_type, customer_info)
    ...
    def confirm(customer_type, customer_info):
        inc = True
        ...
        if customer_info == []:
            ...
            if inc:
                ...
                if response == "yes":
                    ...
                    finish = messagebox.showinfo('Order Received!', 'Your order number is \n\n'+ order_no +
                                                 '. \n\nPlease wait while we process your order. Thank You!')
                    if finish == "ok":
                        checkout.destroy()
                        startup()
            ...
            if inc:
                ...
                if response == "yes":
                    ...
                    c.execute("""INSERT INTO customer_tbl VALUES (:reward_card, :first_name, :mi, :last_name, :gender,
                     :street_adr, :city, :province, :zipcode, :contact_no, :email, :orders)""",
                              {
                    ...
                    finish = messagebox.showinfo('Order Received!',
    ...
    # express order
    eo_l = Label(frame1, text='Express Order', pady=20, padx=20, bg='#303030', fg='#ffffff',
                 font=('Arial Rounded MT Bold', 18), anchor=W)
    ...
    Checkbutton(frame1, text='Dine-In', variable=orderx_type, onvalue='Dine-In', font=('Arial Bold', 13), width=5).grid(
    ...
    submit_infox = Button(frame1, text="Submit and Confirm Order", bg='red', fg='#ffffff', font=('Arial Bold', 18),
                          command=lambda: get_info('existing'))
    submit_infox.grid(row=1, column=3, rowspan=2, columnspan=2, pady=10)

    registerb = Button(frame1, text="Register for Express Order           >", bg='#58E3E4',
                       font=('Arial Rounded MT Bold', 12), width=30, command=register)
